...
// Boutons de partage : Facebook, X, WhatsApp, Copier le lien.
export function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-sm font-medium text-text-secondary">Partager :</span>
      ...
      <a
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full bg-surface text-text-secondary transition-colors hover:bg-[#1877F2] hover:text-white"
      >
      ...
      <a
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full bg-surface text-text-secondary transition-colors hover:bg-black hover:text-white"
      >
        <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true">
      ...
      <a
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full bg-surface text-text-secondary transition-colors hover:bg-[#25D366] hover:text-white"
      >
        <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true">
      ...
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full bg-surface text-text-secondary transition-colors hover:bg-accent hover:text-white"
      >
